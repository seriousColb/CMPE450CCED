...
module decode_and_send_FSM #(parameter DATA_BITS=8, K=3)(
    input logic clk,
    input logic en,
    input logic [DATA_BITS*2-1:0]encoded,
    output logic done,
    output logic txd
    );
