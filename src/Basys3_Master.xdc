...
set_property PACKAGE_PIN R2 [get_ports en_2]
...
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports TxD_2]
set_property IOSTANDARD LVCMOS33 [get_ports TxD_2]
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports RxD_2]
set_property IOSTANDARD LVCMOS33 [get_ports RxD_2]
##Sch name = JB4
